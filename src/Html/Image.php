...
class Image extends Element {
	...
	public static function create(string $tag = 'img', $content = NULL, iterable $attributes = []) {
		return parent::create($tag, $content, $attributes); // TODO: Change the autogenerated stub
	}
